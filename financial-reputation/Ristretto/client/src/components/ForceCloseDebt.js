...
class ForceCloseDebt extends Component {
    ...
    async onFormSubmit(event) {
        ...
        const stackId = this.contracts.Debt.methods.forceCloseDebt.cacheSend(
            this.state.debtor,
          ...
          <>
            <Container className="mt-4">
              <Row className="justify-content-center">
                <Col lg="6">
                  <Heading.h2>Force Close Debt</Heading.h2>
...
export default withRouter(ForceCloseDebt);